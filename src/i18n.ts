...
export const i18n = {
  bg: {
    ...
    formNote: 'Забележка',
    formNotePlaceholder: 'Допълнителна информация (по желание)',
  ...
  en: {
    ...
    formNote: 'Note',
    formNotePlaceholder: 'Additional details (optional)',
  ...
  ru: {
    ...
    formNote: 'Заметка',
    formNotePlaceholder: 'Дополнительная информация (по желанию)',
