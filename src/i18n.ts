...
export const i18n = {
  bg: {
    ...
    nav: ['Как протича', 'Курсове', 'Категория Б', 'Инструктор', 'FAQ', 'Контакти'],
    ...
    instructorCardText:
      'Дълъг опит, спокоен подход и ясни обяснения. Индивидуално внимание според темпото ви с инструктор от Варна.',
    ...
    mapAddress: 'ж.к. Победа, "ул. Орех" 2, 9009, Варна',
    ...
    prices: [
      'до 5 часа — 25 €/48,90 лв час',
      '6–10 часа — 22 €/43,03 лв час',
      '11–15 часа — 20 €/39,12 лв час',
      '15 часа и нагоре — 17 €/33,25 лв час'
    ],
    perHour: 'лв/час',
    footer: {
  ...
  en: {
    ...
    mapAddress: 'zh.k. Pobeda, "Oreh" St 2, 9009, Varna',
  ...
  ru: {
    ...
    prices: [
      'до 5 часов — 25 €/час / 48,90 лв/час',
      '6–10 часов — 22 €/час / 43,03 лв/час',
      '11–15 часов — 20 €/час / 39,12 лв/час',
      '15 часов и больше — 17 €/час / 33,25 лв/час'
    ],
    perHour: 'лв/час',
    footer: {
